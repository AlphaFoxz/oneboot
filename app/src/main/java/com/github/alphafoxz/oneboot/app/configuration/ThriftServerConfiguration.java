...
public class ThriftServerConfiguration implements ApplicationListener<ContextClosedEvent> {
    private static TServer server;
    @Resource
    private AppProperties appProperties;

    @Autowired
    public void startServer(CommonConfiguration commonConfiguration) {
