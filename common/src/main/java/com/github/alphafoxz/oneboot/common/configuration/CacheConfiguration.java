...
import com.github.alphafoxz.oneboot.common.annotations.spring.ConditionalOnPropertyEnum;
...
public class CacheConfiguration {
    @Bean
    @ConditionalOnPropertyEnum(name = "oneboot.common.cache-strategy", enumClass = CommonProperties.CacheStrategyEnum.class, includeAnyValue = "caffeine")
    public Caffeine<Object, Object> caffeine() {
        return Caffeine.newBuilder()
                .maximumSize(CommonConstants.CACHE_MAX_SIZE)
                .expireAfterWrite(CommonConstants.CACHE_EXPIRE_TIME);
    }
    ...
    @Bean
    @ConditionalOnPropertyEnum(name = "oneboot.common.cache-strategy", enumClass = CommonProperties.CacheStrategyEnum.class, includeAnyValue = "redis")
