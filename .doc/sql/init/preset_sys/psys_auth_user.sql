...
INSERT INTO preset_sys.psys_auth_user (id, username, password, nickname, subject_id, account_id, enabled, expired, description) VALUES (1704372320224808960, 'security_admin', '$2a$10$/mcrnAq/CSm4DEsd7U/imexxb32ZGb3rOPrVm0vAJh8/vkzKEtLSu', '安全管理员', 1704372248082780160, 1706192606767222784, true, false, null);
INSERT INTO preset_sys.psys_auth_user (id, username, password, nickname, subject_id, account_id, enabled, expired, description) VALUES (1734113308690223104, 'admin', '$2a$10$VngEJfSKnryFpWJat2x/yelyXoMIqRZJvNIf0dd.voie4NBP19ZNS', '系统管理员', 1734113308765720576, 1734113308765720577, true, false, null);
