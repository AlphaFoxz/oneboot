...
class Const {
    ...
    public static final TokenVo token = new TokenVo("accessToken", "refreshToken", OffsetDateTime.now());
    ...
    public static final Account adminAccount = Account.builder()
            .id(1L)
            ...
            .updateTime(now)
            .build();
    public static final User adminUser = User.builder()
            .id(1L)
