...
public class CacheConfiguration {
    @Bean
    @ConditionalOnPropertyEnum(name = "oneboot.core.cache-strategy", enumClass = CoreProperties.CacheStrategyEnum.class, includeAnyValue = "caffeine")
    public Caffeine<Object, Object> caffeine() {
        return Caffeine.newBuilder()
                .maximumSize(CoreConstants.CACHE_MAX_SIZE)
                .expireAfterWrite(CoreConstants.CACHE_EXPIRE_TIME);
    }
    ...
    @Bean
    @ConditionalOnPropertyEnum(name = "oneboot.core.cache-strategy", enumClass = CoreProperties.CacheStrategyEnum.class, includeAnyValue = "redis")
