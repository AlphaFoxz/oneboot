...
/**
 * PsysDacAuthorization表增删改查service
 */
@Slf4j
@Getter
@Service
public class PsysDacAuthorizationCrudService extends AbstractCachedCrudService<PsysDacAuthorization, PsysDacAuthorizationPo, PsysDacAuthorizationRecord> {
    @Resource
