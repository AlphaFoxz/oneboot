...
public record PsysAbacDynamicAuthorizationPo(
    @NonNull Long id,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PsysAbacDynamicAuthorizationPo other = (PsysAbacDynamicAuthorizationPo) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PsysAbacDynamicAuthorizationPo (");
