...
@javax.annotation.processing.Generated(value = "Autogenerated by Thrift Compiler (0.18.1)", date = "2023-09-01")
public class SdkThriftTemplateDto implements org.apache.thrift.TBase<SdkThriftTemplateDto, SdkThriftTemplateDto._Fields>, java.io.Serializable, Cloneable, Comparable<SdkThriftTemplateDto> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SdkThriftTemplateDto");
  ...
  private static final org.apache.thrift.protocol.TField INCLUDES_FIELD_DESC = new org.apache.thrift.protocol.TField("includes", org.apache.thrift.protocol.TType.MAP, (short)6);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SdkThriftTemplateDtoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SdkThriftTemplateDtoTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,SdkThriftTemplateDto> includes; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.CONTENT, new org.apache.thrift.meta_data.FieldMetaData("content", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.INCLUDES, new org.apache.thrift.meta_data.FieldMetaData("includes", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, SdkThriftTemplateDto.class))));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SdkThriftTemplateDto.class, metaDataMap);
  }

  public SdkThriftTemplateDto() {
  }
  ...
  public SdkThriftTemplateDto(
    ...
    java.util.Map<java.lang.String,SdkThriftTemplateDto> includes)
  {
    this();
   ...
   */
  public SdkThriftTemplateDto(SdkThriftTemplateDto other) {
    ...
    if (other.isSetIncludes()) {
      java.util.Map<java.lang.String,SdkThriftTemplateDto> __this__includes = new java.util.HashMap<java.lang.String,SdkThriftTemplateDto>(other.includes.size());
      for (java.util.Map.Entry<java.lang.String, SdkThriftTemplateDto> other_element : other.includes.entrySet()) {

        java.lang.String other_element_key = other_element.getKey();
        SdkThriftTemplateDto other_element_value = other_element.getValue();

        java.lang.String __this__includes_copy_key = other_element_key;

        SdkThriftTemplateDto __this__includes_copy_value = new SdkThriftTemplateDto(other_element_value);

        __this__includes.put(__this__includes_copy_key, __this__includes_copy_value);
      }
  ...
  @Override
  public SdkThriftTemplateDto deepCopy() {
    return new SdkThriftTemplateDto(this);
  }
  ...
  public SdkThriftTemplateDto setFilePath(@org.apache.thrift.annotation.Nullable java.lang.String filePath) {
    this.filePath = filePath;
    return this;
  }
  ...
  public SdkThriftTemplateDto setFileSeparator(@org.apache.thrift.annotation.Nullable java.lang.String fileSeparator) {
    this.fileSeparator = fileSeparator;
    return this;
  }
  ...
  public SdkThriftTemplateDto setNamespace(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> namespace) {
    this.namespace = namespace;
    return this;
  }
  ...
  public SdkThriftTemplateDto setAst(@org.apache.thrift.annotation.Nullable java.lang.String ast) {
    this.ast = ast;
    return this;
  }
  ...
  public SdkThriftTemplateDto setContent(@org.apache.thrift.annotation.Nullable java.lang.String content) {
    this.content = content;
    return this;
  }
  ...
  public void putToIncludes(java.lang.String key, SdkThriftTemplateDto val) {
    if (this.includes == null) {
      this.includes = new java.util.HashMap<java.lang.String,SdkThriftTemplateDto>();
    }
    this.includes.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.String,SdkThriftTemplateDto> getIncludes() {
    return this.includes;
  }

  public SdkThriftTemplateDto setIncludes(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,SdkThriftTemplateDto> includes) {
    this.includes = includes;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case INCLUDES:
      if (value == null) {
        ...
        setIncludes((java.util.Map<java.lang.String,SdkThriftTemplateDto>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof SdkThriftTemplateDto)
      return this.equals((SdkThriftTemplateDto)that);
    return false;
  }

  public boolean equals(SdkThriftTemplateDto that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(SdkThriftTemplateDto other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SdkThriftTemplateDto(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (includes == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'includes' was not present! Struct: " + toString());
    }
  ...
  private static class SdkThriftTemplateDtoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public SdkThriftTemplateDtoStandardScheme getScheme() {
      return new SdkThriftTemplateDtoStandardScheme();
    }
  }

  private static class SdkThriftTemplateDtoStandardScheme extends org.apache.thrift.scheme.StandardScheme<SdkThriftTemplateDto> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, SdkThriftTemplateDto struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.includes = new java.util.HashMap<java.lang.String,SdkThriftTemplateDto>(2*_map4.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key5;
                @org.apache.thrift.annotation.Nullable SdkThriftTemplateDto _val6;
                for (int _i7 = 0; _i7 < _map4.size; ++_i7)
                {
                  _key5 = iprot.readString();
                  _val6 = new SdkThriftTemplateDto();
                  _val6.read(iprot);
                  struct.includes.put(_key5, _val6);
                }
                iprot.readMapEnd();
              }
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, SdkThriftTemplateDto struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.includes != null) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, struct.includes.size()));
          for (java.util.Map.Entry<java.lang.String, SdkThriftTemplateDto> _iter9 : struct.includes.entrySet())
          {
  ...
  private static class SdkThriftTemplateDtoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public SdkThriftTemplateDtoTupleScheme getScheme() {
      return new SdkThriftTemplateDtoTupleScheme();
    }
  }

  private static class SdkThriftTemplateDtoTupleScheme extends org.apache.thrift.scheme.TupleScheme<SdkThriftTemplateDto> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SdkThriftTemplateDto struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.content);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, SdkThriftTemplateDto> _iter11 : struct.includes.entrySet())
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SdkThriftTemplateDto struct) throws org.apache.thrift.TException {
      ...
      struct.setContentIsSet(true);
      {
        ...
        struct.includes = new java.util.HashMap<java.lang.String,SdkThriftTemplateDto>(2*_map16.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _key17;
        @org.apache.thrift.annotation.Nullable SdkThriftTemplateDto _val18;
        for (int _i19 = 0; _i19 < _map16.size; ++_i19)
        {
          _key17 = iprot.readString();
          _val18 = new SdkThriftTemplateDto();
          _val18.read(iprot);
          struct.includes.put(_key17, _val18);
        }
      }
      struct.setIncludesIsSet(true);
