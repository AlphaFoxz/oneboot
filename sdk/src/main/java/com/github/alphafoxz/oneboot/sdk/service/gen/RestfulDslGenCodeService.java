...
import com.github.alphafoxz.oneboot.sdk.service.gen.code.*;
...
@Slf4j
@Service
public class RestfulDslGenCodeService implements SdkGenCodeIface.Iface {
    @Resource
    ...
    public com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkMapResponseDto previewGenerateTsApi(com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkCodeTemplateRequestDto templateDto, String genDir) {
        com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkMapResponseDto result = new com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkMapResponseDto()
                .setId(snowflake.nextId()).setTaskId(templateDto.getTaskId()).setSuccess(false);
        result.setData(MapUtil.newHashMap());
        // 检查基本SDK环境
        SdkListResponseDto checkInfo = restfulDslInfoService.checkThriftErr();
    ...
    public com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkMapResponseDto previewGenerateRustApi(com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkCodeTemplateRequestDto templateDto, String genDir) {
        com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkMapResponseDto result = new com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkMapResponseDto()
                .setId(snowflake.nextId()).setTaskId(templateDto.getTaskId()).setSuccess(false);
        result.setData(MapUtil.newHashMap());
        // 检查基本SDK环境
    ...
    public com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkListResponseDto generateJavaApi(com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkCodeTemplateRequestDto templateDto) {
        com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkListResponseDto result = new com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkListResponseDto()
                .setId(snowflake.nextId()).setTaskId(templateDto.getTaskId()).setSuccess(false);
        // 检查基本SDK环境
        SdkListResponseDto checkInfo = restfulDslInfoService.checkThriftErr();
        if (!checkInfo.isSuccess()) {
    ...
    public com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkMapResponseDto previewGenerateSql(com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkCodeTemplateRequestDto templateDto) {
        com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkMapResponseDto result = new com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkMapResponseDto()
                .setId(snowflake.nextId()).setTaskId(templateDto.getTaskId()).setSuccess(false);
        result.setData(MapUtil.newHashMap());
        // 检查基本SDK环境
    ...
    private ParseRestfulSyntaxTreeUtil.RestfulRootBean parseRestfulRoot(com.github.alphafoxz.oneboot.sdk.gen.restful.dtos.SdkCodeTemplateDto templateDto) {
        ParseRestfulSyntaxTreeUtil.RestfulRootBean restfulRoot;
        ParseRestfulSyntaxTreeUtil.RootBean rootBean;
        try {
            restfulRoot = ParseRestfulSyntaxTreeUtil.parseRestfulRoot(templateDto);
