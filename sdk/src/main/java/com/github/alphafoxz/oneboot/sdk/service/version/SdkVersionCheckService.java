...
@Service
public class SdkVersionCheckService {
    @Resource
    ...
    public SdkVersionCheckResponse checkRestfulJava(@Nullable Long taskId) {
        ...
        Map<String, Serializable> versionMap = sdkVersionStoreService.genRestfulStore().readFile();
        Map<String, SdkVersionCheckDto> checkResult = MapUtil.newHashMap();
        for (File file : FileUtil.loopFiles(SdkConstants.SDK_GEN_RESTFUL_TEMPLATE_PATH)) {
